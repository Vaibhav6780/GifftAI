    ...
    <div className="flex flex-col gap-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-slate-500 dark:text-slate-400">Manage user accounts and role assignments.</p>
        </div>
        {canCreate && (
          <Link to="/users/new">
            <Button>
            ...
            <Tbody>
              {data?.items.map((user) => (
                <Tr key={user.id}>
                  ...
                  <Td>
                    <Link to={`/leads?ownerId=${user.id}`} className="font-medium text-brand-600 hover:underline dark:text-brand-500">
